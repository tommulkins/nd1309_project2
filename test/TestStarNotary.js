...
it("lets 2 users exchange stars", async () => {
  ...
  let tokenId2 = 30;
  let instance = await StarNotary.deployed();
  await instance.createStar("Star 1", tokenId1, {
    from: accounts[0],
  });
  await instance.createStar("Star 2", tokenId2, {
    from: accounts[1],
  });
...
it("lookUptokenIdToStarInfo test", async () => {
  ...
  let tokenId = 10;
  let instance = await StarNotary.deployed();
  await instance.createStar("another awesome star!", tokenId, {
    from: accounts[0],
  });
